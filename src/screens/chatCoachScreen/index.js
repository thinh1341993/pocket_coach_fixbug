...
import {getUser, getCoachMsg} from '../../redux/actions';
...
const ChatCoachScreen = ({route, navigation}) => {
    ...
    const {chatCoachMsg} = useSelector(state => state.getChatCoachReducer);
    ...
    const fetchMsgCoachFB = () => dispatch(getCoachMsg());
...
export default ChatCoachScreen;
